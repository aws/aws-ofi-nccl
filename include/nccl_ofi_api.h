...
ncclResult_t nccl_net_ofi_listen(int dev, void* handle, void** lComm);
ncclResult_t nccl_net_ofi_listen_v4(int dev, void* handle, void** listenComm);
ncclResult_t nccl_net_ofi_connect(int dev, void* handle, void** sComm);
...
ncclResult_t nccl_net_ofi_regMr_sizet(
	void* comm, void* data, size_t size, int type, void** mhandle);
...
ncclResult_t nccl_net_ofi_isend(
	void* sComm, void* data, int size, int tag, void* mhandle, void** request);
...
ncclResult_t nccl_net_ofi_iflush(
	void* rComm, int n, void** buffers, const int* sizes, void** mhandles, void** request);

...
ncclResult_t nccl_net_ofi_listen_v11(int dev, void* handle, void **listenComm,
...
ncclResult_t nccl_net_ofi_connect_v11(int dev, void *handle, void **sendComm, int trafficClass,
				      unsigned int domain_key, unsigned int resource_key);

 ...
 */
#define nccl_net_ofi_check_return(retval)						\
	({									\
...
#define nccl_net_ofi_retval_translate(ret)				\
	({								\
		...
		retval_translate_nccl_retval = nccl_net_ofi_check_return(nccl_net_ofi_retval_translate_impl(retval_translate_tmp_ret)); \

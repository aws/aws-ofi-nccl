...
ncclResult_t nccl_net_ofi_write_inline(void* rComm, void* data, int size, void* dest, void *mhandle, void** request) {
	ncclResult_t ret;
	/* Retrieve and validate comm */
        nccl_net_ofi_comm_t *base_comm =
                (nccl_net_ofi_comm_t *)rComm;
	nccl_net_ofi_ep_t *base_ep = NULL;
	...
	NCCL_OFI_WARN("nccl_net_ofi_write_inline");
	ret = base_ep->write_inline(base_comm, data, size, dest, mhandle);

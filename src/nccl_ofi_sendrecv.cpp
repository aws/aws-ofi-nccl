...
static inline struct fid_cq *sendrecv_domain_get_cq(nccl_net_ofi_domain_t *base_domain)
{
...
static nccl_net_ofi_domain_t *nccl_net_ofi_sendrecv_device_create_domain(nccl_net_ofi_device_t *base_device)
{
	...
	domain->base.get_cq = sendrecv_domain_get_cq;
...
static inline struct fi_info *sendrecv_device_get_info(nccl_net_ofi_device_t *device)
{
				...
				int dev_id, struct fi_info *info)
{
	...
	device->base.get_info = sendrecv_device_get_info;

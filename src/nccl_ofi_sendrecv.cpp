...
{
	return (nccl_net_ofi_sendrecv_device_t*)ep->sendrecv_endpoint_get_domain()->base.device;
}
...
{
	nccl_net_ofi_domain_t *base_domain = &ep->sendrecv_endpoint_get_domain()->base;

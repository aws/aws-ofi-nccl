...
int nccl_net_ofi_sendrecv_send_comm::close()
{
	...
	// Using free() instead of delete since this was allocated using calloc
	// and new was called as placement new on the calloc-ed memory.
	// TODO: Later it maybe refactored to use new and delete.
	free(this);

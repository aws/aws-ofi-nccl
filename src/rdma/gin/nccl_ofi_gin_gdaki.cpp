						...
						void **mhandle, void **ginHandle)
{
	...
	int ret;
	{
		...
		/* Pass NCCL's mrFlags through; the registration path relaxes ordering
		 * on GIN symmetric data buffers unless the caller forces strict
		 * ordering (FORCE_SO) for ordering-sensitive MRs. */

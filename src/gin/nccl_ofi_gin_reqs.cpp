...
int nccl_net_ofi_gin_op_req_t::ctx_handle_cq_entry
...
int nccl_net_ofi_gin_op_req_t::ctx_handle_error_entry
		(nccl_net_ofi_gin_context *ctx,
		 struct fid_cq *cq,
...
nccl_net_ofi_gin_op_req_t::nccl_net_ofi_gin_op_req_t() :
	ctx({.ofi_ctx = {},
	     .handle_cq_entry = ctx_handle_cq_entry,
	     .handle_error_entry = ctx_handle_error_entry})
{ }

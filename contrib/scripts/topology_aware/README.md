...
- AWS credentials with EC2 describe permissions configured:
  ...
  **Option 2: Using environment variables**:
     ...
     ```
     Copy the above environment variables of your IAM role and paste them into your terminal.
...
1. Create an input hostfile with one hostname per line. For example, this can be generated using a Slurm command:
   ```
